...
## [Unreleased]
### Added
- New field `Connection.IsAnycast` (JSON `connection.is_anycast`): whether the IP address is announced via anycast,
...
[Unreleased]: https://github.com/ipregistry/ipregistry-go/compare/v1.1.0...HEAD
[1.1.0]: https://github.com/ipregistry/ipregistry-go/compare/v1.0.0...v1.1.0
